...
Note: If the root URL (/) shows "Cannot GET /", it is expected behaviour since the services expose API endpoints and not a frontend UI.
...
Screenshots:Screenshots showing running containers, Docker logs, and browser testing are attached for validation.
